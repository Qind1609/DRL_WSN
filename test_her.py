#! /media/qind/0E8A10FB0E8A10FB/anaconda3/envs/pytorch_env/bin/python

import random
import torch
import os
from HER.ddpg_her_normailization import *
import numpy as np
...
class Hyper_Params:
    def __init__(self):
        ...
        # path to save model
        self.save_dir = (
            "/home/qind/Desktop/git/DRL_WSN/HER/saved_models"
        )
